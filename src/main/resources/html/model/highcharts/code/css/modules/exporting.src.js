        ...
        defaultOptions.exporting = {
            ...
            buttons: {
                ...
                contextButton: {
                     ...
                     * @sample {highcharts} highcharts/exporting/buttons-contextbutton-component/ Override the menu items
                     * @sample {highstock} highcharts/exporting/buttons-contextbutton-onclick/ Skip the menu and export the chart directly
                     * @sample {highstock} highcharts/exporting/buttons-contextbutton-component/ Override the menu items
                     * @sample {highmaps} highcharts/exporting/buttons-contextbutton-onclick/ Skip the menu and export the chart directly
                     * @sample {highmaps} highcharts/exporting/buttons-contextbutton-component/ Override the menu items
                     * @since 2.0
                     * @product highcharts highstock highmaps
                     */
                    menuItems: [
